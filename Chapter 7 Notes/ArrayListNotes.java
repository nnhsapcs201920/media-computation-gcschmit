...
public class ArrayListNotes
{
    public static void main(String[] args)
    {
         ...
         *      specified as the type of the elements in a Generic. Instead, we use
         *      the corresponding Wrapper Class (e.g., Integer, Double, Boolean).
         */
    ...
    public static ArrayList<Integer> createRandomIntegerList(int size, int range)
    {
        ...
        for(int i = 0; i < size; i++)
        {
             ...
             * 
             *  Autoboxing:
             *      Primitives values are automatically converted to their
             *          corresponding wrapper class. However, type promotion
             *          does not occur.
             */
            list.add(value);
        }
